  ...
  return (
    <main style={{ padding: "32px", maxWidth: "1100px", margin: "0 auto", fontFamily: "system-ui, sans-serif" }}>
      ...
      <section style={{ marginTop: "28px", padding: "16px", background: "#f7fee7", border: "1px solid #bbf7d0", borderRadius: "12px" }}>
        ...
        <p>
          Auto-publish is disabled. Public campaign copy must not claim 3 meals per day, federal payment, guaranteed free meals,
          guaranteed approval, 84 days, 90 days, official government program, proof numbers, approval rates, or testimonials unless verified and approved.
        </p>
      </section>
    </main>
  );
